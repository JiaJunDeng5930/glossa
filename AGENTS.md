...
|glossa.ai_requests.glossa_backend.gloss|glossa.ai_requests.glossa_backend.gloss.{item_validation,validation}
|glossa.ai_requests.glossa_backend.gloss.item_validation|glossa.ai_requests.glossa_backend.gloss.item_validation.{fields}
|glossa.ai_requests.glossa_backend.gloss.item_validation.fields|glossa.ai_requests.glossa_backend.gloss.item_validation.fields.{}
|glossa.ai_requests.glossa_backend.gloss.validation|glossa.ai_requests.glossa_backend.gloss.validation.{items}
|glossa.ai_requests.glossa_backend.gloss.validation.items|glossa.ai_requests.glossa_backend.gloss.validation.items.{}
...
|glossa.card_creation.note_request.response_payload|glossa.card_creation.note_request.response_payload.{created_ids}
|glossa.card_creation.note_request.response_payload.created_ids|glossa.card_creation.note_request.response_payload.created_ids.{}
...
|glossa.extension_contracts.message_envelopes.error_payload|glossa.extension_contracts.message_envelopes.error_payload.{}
...
|glossa.extension_contracts.message_envelopes.gloss_scan_chunk|glossa.extension_contracts.message_envelopes.gloss_scan_chunk.{accepted,payload}
...
|glossa.extension_contracts.message_envelopes.gloss_scan_end|glossa.extension_contracts.message_envelopes.gloss_scan_end.{scan_id}
...
|glossa.extension_contracts.message_envelopes.gloss_scan_start|glossa.extension_contracts.message_envelopes.gloss_scan_start.{accepted}
...
|glossa.page_translation.candidate_scan|glossa.page_translation.candidate_scan.{overflow_clip,overflow_scroll,shadow_root_observation,viewport_option,viewport_tokens}
