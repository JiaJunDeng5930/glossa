...
|requirements.cli|requirements.cli.{command,help,option}
...
|requirements.types.hunk_line|requirements.types.hunk_line.{deleted,old_path}
|requirements.types.hunk_line.deleted|requirements.types.hunk_line.deleted.{}
